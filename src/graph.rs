...
use crate::{Element, MolMap, bond::BondType, core::CoreGraph, entities::*, fragment::FragmentCentre, id::*};
...
pub struct MolGraph {
    pub(crate) core: CoreGraph,
}

impl MolMap for MolGraph {
    fn new() -> Self {
        Self {
            core: CoreGraph::new(),
        }
...
mod tests {
    ...
    /// - six atoms
    /// - five bonds
    fn meoh_map() -> MolGraph {
        let mut mm = MolGraph::new();
